...
const Hero = (props) => {
  ...
  return (
    <div className={clsx(classes.root, className)} {...rest}>
      <Image
        src='https://www.roastycoffee.com/wp-content/uploads/Depositphotos_93910882_xl-2015-scaled.jpg'
        srcSet='https://www.roastycoffee.com/wp-content/uploads/Depositphotos_93910882_xl-2015-scaled.jpg 2x'
        alt='About'
